...
i3-msg 'workspace '$ws3'; append_layout ~/.config/i3/layouts/ws02.json'
i3-msg 'workspace '$ws4'; append_layout ~/.config/i3/layouts/ws02.json'
...
sleep 2
i3-msg 'workspace '$ws5'; exec firefox'
sleep 2
i3-msg 'workspace '$ws9'; exec firefox'
sleep 2
