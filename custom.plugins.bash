...
# colors
cols() {
  # profile='org/gnome/terminal/legacy/profiles:/:c237311d-9c0c-41ac-877c-efb459f3b6b3'
  ...
  # echo $full_profile
  IFS=$'\r\n' GLOBIGNORE='*' command eval  'XYZ=($(cat $HOME/Documents/colors.vim))'
...
# profile='org/gnome/terminal/legacy/profiles:/:c237311d-9c0c-41ac-877c-efb459f3b6b3'
# dconf write /$profile/background-color "'#2e3440'"
